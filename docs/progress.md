...
| P4-01 | blocked | GFX-REF-001 cinematic v6のart direction承認を反映し、REF-002北壁preview、REF-003材質sheet、REF-004配置図を制作 | 寸法、北壁必須物、字幕安全域、4壁配置、材質継承、窓・別開口・生成文字なしを目視検収 | 利用者によるREF-002 / REF-004のcanonical room geometry承認 |
| P4-02 | pending |  |  | P4-01 |
| P4-03 | pending |  |  | P4-01 |
| P4-04 | pending |  |  | 本番音声 |
