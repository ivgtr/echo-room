...
| P4-01 | blocked | 3階層の探索情報、密度上限、誤誘導禁止、壁別dressingを正本化し、WIDE-001〜004の環境ドレッシング改訂previewと4面比較sheetを制作 | 4面1672×941・比較sheet 1920×1080、必須対象・edge cue・禁止decoyの目視照合、`npm run check` | 利用者による4面の探索密度・cross-view承認 |
| P4-02 | pending |  |  | P4-01 |
| P4-03 | pending |  |  | P4-01 |
| P4-04 | pending |  |  | 本番音声 |
