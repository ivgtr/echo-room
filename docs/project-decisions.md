...
| シナリオ | 主要7問、20分差、未来の主人公、4 PACKET、単一endingを変更しない | requirements 2章・7章・8章 |
...
| D-08 | 全主要checkpoint直後の進行自動保存1枠と、即時反映する設定保存1枠を分離する。7問進行schema v4と設定schema v4の現行形式だけを受理し、進行消去後も設定・既読状態を保持する | なし |
